# Contributing to Client Portal Lite

Client Portal Lite is part of the Fox & Hen public tool set. Contributions should keep the project useful, inspectable, forkable, and safe to demonstrate in public.

## Good First Contributions

- Add or improve a synthetic sample scenario that demonstrates: A static client workspace for milestones, approvals, decisions, file requests, closeout checks, and status exports.
